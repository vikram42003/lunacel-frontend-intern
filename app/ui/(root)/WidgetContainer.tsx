...
const WidgetContainer = ({ children, className }: Readonly<{ children: React.ReactNode; className: string }>) => {
  return (
    <div className={className + " flex flex-col"}>
      <div className="flex h-full rounded-2xl bg-widget-container-bg offset-box-shadow px-3 py-4 3xl:px-6 3xl:py-8">
      ...
      <hr className="block h-1 3xl:h-2 mt-4 3xl:mt-12 w-[85%] mx-auto bg-neutral-700 border-0 rounded-lg shadow-[3px_3px_10px_2px_rgba(0,0,0,0.5)]" />
    </div>
  );
};
